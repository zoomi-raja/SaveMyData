...
public class WebsitesFragment extends android.support.v4.app.Fragment {

    private OnWebsiteFragmentListener mListener;
...
//        }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnWebsiteFragmentListener) {
            mListener = (OnWebsiteFragmentListener) context;
        } else {
     ...
     */
    public interface OnWebsiteFragmentListener {
